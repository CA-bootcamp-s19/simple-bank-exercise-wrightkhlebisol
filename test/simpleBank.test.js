...
contract('SimpleBank', function (accounts) {
    ...
    it("should mark addresses as enrolled", async () => {
        ...
        const aliceEnrolled = await instance.enrolled(alice, {
            from: alice
        })
    ...
    it("should not mark unenrolled users as enrolled", async () => {
        const ownerEnrolled = await instance.enrolled(owner, {
            from: owner
        })
    ...
    it("should withdraw correct amount", async () => {
        ...
        await instance.withdraw(deposit, {
            from: alice
        })
        const balance = await instance.getBalance({
            from: alice
    ...
    it("should not be able to withdraw more than has been deposited", async () => {
        ...
        await catchRevert(instance.withdraw(deposit + 1, {
            from: alice
        }))
    })
    ...
    it("should emit the appropriate event when a withdrawal is made", async () => {
        ...
        var result = await instance.withdraw(deposit, {
            from: alice
        })
